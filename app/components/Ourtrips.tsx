  ...
  return (
    <section className="px-6 lg:px-20 py-2 mt-15 relative">
      <div className="text-center mb-8">
        <h2 className={`${pacifico.className} text-4xl text-[#0A7BBE]`}>Our Tours</h2>
        <p className="text-6xl text-[#0A7BBE] mt-2">Discover Our Best Tours</p>
      </div>
      ...
      <div className="mt-10 flex justify-center gap-3">
        {tours.map((_, idx) => (
          <button
            ...
            className={`h-3 w-3 -mt-2 rounded-full transition ${idx === currentIndex ? 'bg-[#0a7bbe]' : 'border border-[#2a4b4b]'}`}
          />
        ))}
      </div>
