    ...
    <section className="w-full px-6 lg:px-20 py-10">
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          >
Siri Sand Tours          </motion.p>

          {/* Heading */}
          <motion.h1
            variants={item}
className="text-3xl sm:text-4xl font-bold text-[#0A7BBE] -mt-5 leading-tight"
          >
